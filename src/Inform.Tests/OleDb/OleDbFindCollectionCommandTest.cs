/*
 * OleDbFindCollectionCommandTest.cs	12/26/2002
 *
...
namespace Inform.Tests.OleDb {
	...
	/// <summary>
	/// Summary description for OleDbFindCollectionCommandTest.
	/// </summary>
	[TestFixture]
	public class OleDbFindCollectionCommandTest : FindCollectionCommandTest {
